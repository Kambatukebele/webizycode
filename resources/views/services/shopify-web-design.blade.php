      ...
      <div class="mb-10 lg:grid lg:gap-4 lg:grid-cols-2 lg:grid-rows-2 xl:grid-cols-3">
        <x-card-two>
          ...
          <x-slot:cardTwoDescription>
            Before starting the design process, it is important to research the target audience, competitors, and overall goals and vision of the website. This will inform the design decisions and help create a layout that is tailored to the needs of the audience and brand
          </x-slot:cardTwoDescription>
        </x-card-two>
        {{-- 2 --}}
        <x-card-two>
          ...
          <x-slot:cardTwoDescription>
            Our Collaboration approach ensures you have access to the full scope of the project before we move on to the next step. On going access of our designing process will give you a peace of mind and be sure that your website design will exceed your expectations.
          </x-slot:cardTwoDescription>
        </x-card-two>
        {{-- 3 --}}
        <x-card-two>
          ...
          <x-slot:cardTwoDescription>
            Wireframing is the process of creating a visual representation of the website's structure and layout. This helps to define the overall look and feel of the site, and to ensure that all necessary elements are included.
          </x-slot:cardTwoDescription>
        </x-card-two>
        {{-- 4 --}}
        <x-card-two>
          ...
          <x-slot:cardTwoDescription>
            Once the wireframe is approved, the designer will create a responsive design for the website, including colors, typography, and images using different tools like Figma, InVision or Photoshop.
          </x-slot:cardTwoDescription>
        </x-card-two>
        {{-- 5 --}}
        <x-card-two>
          ...
          <x-slot:cardTwoDescription>
            Our team of designers will make revisions to the layout as needed based on feedback from the client or testing results.
          </x-slot:cardTwoDescription>
        </x-card-two>
        {{-- 6 --}}
        <x-card-two>
          ...
          <x-slot:cardTwoDescription>
            Once the designer has completed the layout and the client has approved it, the website will be in development phrase.
          </x-slot:cardTwoDescription>
        </x-card-two>
      </div>
  </section>
