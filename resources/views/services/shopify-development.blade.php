    ...
    <div
      ...
      <div class="block  mt-5 lg:w-[400px] xl:w-[600px]">
        ...
        <p class="font-normal  text-gray-700 text-base">
          ...
          custom-designed theme, advanced functionality, or seamless user experiences, we are dedicated to delivering
          solutions
        ...
        <p class="font-normal  text-gray-700 text-base">
          ...
          robust. Our
          themes are designed to be scalable, mobile-responsive, and secure, providing you with the flexibility and
          reliability
    ...
    <div
      ...
      <div class="block  mt-5 lg:w-[400px] xl:w-[600px]">
        ...
        <p class="font-normal text-gray-700 text-base">
          ...
          are
          precisely tailored to meet your unique business requirements, harnessing the latest technologies to support
          your
          e-commerce growth.
        </p>
        <br>
        <p class="font-normal  text-gray-700 text-base">
          ...
          need a
          plugin to streamline your inventory management, enhance customer engagement, or optimize your checkout
          process, we are
        ...
        <p class="font-normal  text-gray-700 text-base">
          ...
          that can
          evolve and adapt alongside your business. Our plugins are designed to be scalable, user-friendly, and secure,
          providing
          you with the flexibility and reliability you need to thrive in the competitive e-commerce landscape.
        </p>
      </div>
    </div>
  </section>
