@section('title', 'Youtube video - view')
@section('description', 'Youtube Videos')
<x-app-layout>
  <x-slot name="header">
              ...
              <tbody>
                ...
                <tr
                  ...
                  <td class="px-6 py-4 border text-center w-[150px]">
                    ...
                    <p class="bg-green-600 py-2 w-[90px] rounded-md text-white">{{ $youtube->status }}</p>
                    @else
                    <p class="bg-yellow-600 py-2 w-[90px] rounded-md text-white ">{{ $youtube->status }}</p>
                    @endif
                  </td>
                  <td class="px-6 py-4 border text-center">
                    <a href="{{ route('youtube.edit', ['id'=> $youtube->id]) }}">
