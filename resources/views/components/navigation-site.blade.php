...
<nav class="hidden relative lg:flex lg:justify-between lg:items-center lg:w-full ">
    ...
    <ul class="lg:flex lg:justify-between lg:items-center lg:w-[550px]">
        <li class="lg:text-white lg:text-xs uppercase lg:font-semibold leading-4  hover:text-black transition-all">
            ...
            <a class="" href="{{ route('home') }}">@lang('public.home')</a>
        </li>
        <li id="services"
            ...
            <a class="" href="{{ route('services') }}">@lang('public.services')</a>
        ...
        <li class="lg:text-white lg:text-xs uppercase lg:font-semibold leading-4  hover:text-black transition-all">
            ...
            <a class="" href="{{ route('blog') }}">@lang('public.blog')</a>
        </li>
        <li class="lg:text-white lg:text-xs uppercase lg:font-semibold leading-4  hover:text-black transition-all">
            {{-- <a class="" href="{{ route('youtube.show') }}">Youtube</a> --}}
            <a class="" href="{{ route('youtube.show') }}">@lang('public.youtube')</a>
        </li>
        <li class="lg:text-white lg:text-xs uppercase lg:font-semibold leading-4  hover:text-black transition-all">
            {{-- <a class="" href="{{ route('portfolio.show') }}">Portfolio</a> --}}
            <a class="" href="{{ route('portfolio.show') }}">@lang('public.portfolio')</a>
        </li>
        <li class="lg:text-white lg:text-xs uppercase lg:font-semibold leading-4  hover:text-black transition-all">
            {{-- <a class="" href="{{ route('contact.index') }}">Contact Us</a> --}}
            <a class="" href="{{ route('contact.index') }}">@lang('public.contact us')</a>
        </li>
...
<!-- end Navigation and logo -->
  {{-- Changing language --}}
    <div class="fixed left-2 rounded-md py-1 top-20 z-10 bg-white w-11 h-fit flex justify-center items-center flex-col">
        <a href="locale/en" class="us block w-8 h-fit  bg-transparent">
            <img class="block w-full h-full object-cover object-center" src="{{ '/assets/images/united-states.png' }}" alt="">
        </a>    
        <a href="locale/cs" class="cz hidden w-8 h-fit  bg-transparent">
            <img class="block w-full h-full object-cover object-center" src="{{ '/assets/images/czech-republic.png' }}" alt="">
        </a>        
        <a href="locale/fr" class="fr hidden w-8 h-fit bg-transparent">
            <img  class="block w-full h-full object-cover object-center" src="{{ '/assets/images/france.png' }}" alt="">
        </a>
    </div>