...
<nav class="hidden lg:flex lg:justify-between lg:items-center lg:w-full">
  ...
  <ul class="lg:flex lg:justify-between lg:items-center lg:w-[400px]">
    <li class="lg:text-black lg:text-base lg:font-normal hover:border-b-2 hover:border-white transition-all"><a class=""
        href="/">Home</a></li>
    <li id="services"
      class="lg:relative  lg:text-black lg:text-base lg:font-normal hover:border-b-2 hover:border-white transition-all">
      <a class="" href="{{ route('services') }}">Services</a>
      <div id="services-card"
        class="hidden lg:absolute lg:hidden lg:bg-purple-700 lg:w-[200px] lg:mt-2 lg:z-10 lg:rounded-md lg:border">
        ...
        <a class="hidden lg:block lg:text-white lg:my-3 lg:font-Nunito lg:px-3 lg:text-sm hover:underline hover:text-purple-700"
          href="{{ route('services.tiktok') }}">TikTok</a>
        <a class="hidden lg:block lg:text-white lg:my-3 lg:font-Nunito lg:px-3 lg:text-sm hover:underline hover:text-purple-700"
    ...
    <li class="lg:text-black lg:text-base lg:font-normal hover:border-b-2 hover:border-white transition-all">
    ...
    {{-- <li class="lg:text-black lg:text-base lg:font-normal hover:border-b-2 hover:border-white transition-all"><a class="" href="/">Home</a></li> --}}
  </ul>
  <!-- CTA -->
  <div class="block">
    <a class="block text-center text-base font-normal w-[200px] mx-auto py-3 my-9 rounded-full uppercase bg-purple-700 border-2 border-white text-white hover:bg-black hover:font-semibold transition-all"
